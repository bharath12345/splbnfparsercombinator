package com.glassbeam.scalar.core.parser.spl

import com.glassbeam.scalar.core.parser.colops.ColOp
import com.glassbeam.scalar.core.parser.spl.lexer._
import com.glassbeam.scalar.core.parser.spl.compiler.TokenSetType.TokenSetType
...
package object compiler {
  ...
  case class TableAST(namespace: NamespaceAST, table: TABLE, icon: ICON, columns: List[COLUMN], colops: List[ColumnOp], linegrab: Option[LINEGRAB],
